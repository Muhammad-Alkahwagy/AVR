...
#define CTRL_REG   PORTA  //Control register is connected to port A on the MCU (pins A0-A2)

#define RS_PIN     PIN0   //register select pin
#define RW_PIN     PIN1   //read/write pin
#define EN_PIN     PIN2   //enable pin
